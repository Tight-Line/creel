...
- Compaction now clears `embedding_id` on compacted source chunks. The embeddings are deleted from the vector store during compaction, so the stale reference was misleading.
