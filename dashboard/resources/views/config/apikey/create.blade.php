...
@section('title', 'Create API Key Config')

@section('content')
    <div class="mb-6">
        <h2 class="text-xl font-semibold">Create API Key Config</h2>
    </div>

    <div class="bg-white rounded shadow max-w-lg">
        <form method="POST" action="{{ route('config.apikey.store') }}" class="p-6 space-y-5">
            @csrf
