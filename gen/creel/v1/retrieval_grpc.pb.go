...
const (
	RetrievalService_Search_FullMethodName     = "/creel.v1.RetrievalService/Search"
	RetrievalService_GetContext_FullMethodName = "/creel.v1.RetrievalService/GetContext"
)
...
func (c *retrievalServiceClient) GetContext(ctx context.Context, in *GetContextRequest, opts ...grpc.CallOption) (*GetContextResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetContextResponse)
	err := c.cc.Invoke(ctx, RetrievalService_GetContext_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRetrievalServiceServer) GetContext(context.Context, *GetContextRequest) (*GetContextResponse, error) {
...
func _RetrievalService_GetContext_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetContextRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RetrievalServiceServer).GetContext(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RetrievalService_GetContext_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RetrievalServiceServer).GetContext(ctx, req.(*GetContextRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RetrievalService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "creel.v1.RetrievalService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RetrievalService_GetContext_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "creel/v1/retrieval.proto",
}
